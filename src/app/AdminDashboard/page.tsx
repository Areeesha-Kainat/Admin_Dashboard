...
const AdminDashboard = () => {
  ...
  // Static data for Cars, Bookings, and Categories
  const carsData = [
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">Manage your car&apos;s categories here.</p>
            <button
      ...
      {activeSection && (
        <div className="mt-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            ...
            {activeSection === "users" &&
              users.map((user) => (
                <div key={user.email} className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex justify-between items-center">
                    <div>
